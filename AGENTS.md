...
This repository is a single self-contained **Next.js 16 / React 19** marketing website ("Celebration Cleaning") managed with **pnpm**. There is no database — SEO data lives statically in `src/data/seo-data.ts`. Contact form submissions are forwarded to **Booking Broom** via `POST /api/bookings`.

### Services

| Service | Command | Port | Notes |
|---|---|---|---|
| Next.js web app | `pnpm dev` | 3000 | The only service. Dev server uses Turbopack. |
